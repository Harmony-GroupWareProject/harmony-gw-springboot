...
public class HarmonyApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// 사용자 이름: user, 암호: user
		urepository.save(new Employee("user", "$2a$10$NVM0n8ElaRgg7zWO1CxUdei7vWoPg91Lz2aYavh9.f9q0e4bRadue", "이유림", "", "010-6698-5279", "usejin0914@gmail.com", "매니저" ,"USER", LocalDate.of(2024,05,30)));
